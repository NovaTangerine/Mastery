...
import { X, LogOut, User, Shield, Gamepad2, FileText, Calendar, Sparkles, CheckCircle2, Copy, Tag } from 'lucide-react';
          ...
          >
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="p-4 rounded-2xl bg-zinc-950/40 border border-zinc-800/80 space-y-3">
                ...
                <div className="flex items-center justify-between text-xs pt-3 border-t border-zinc-800/80 mt-1">
                  <span className="text-zinc-400 font-medium flex items-center gap-2"><Tag className="w-3.5 h-3.5" /> Show Tags by Default</span>
                  <button
                    onClick={() => setDefaultTagVisibility(!defaultTagVisibility)}
                    className="relative inline-flex h-5 w-9 items-center rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-900" style={{ backgroundColor: defaultTagVisibility ? '#fbbf24' : '#3f3f46' }}
                  >
                    <span className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${defaultTagVisibility ? 'translate-x-4' : 'translate-x-1'}`} />
                  </button>
                </div>
              </div>
            </div>
